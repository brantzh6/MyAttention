...
def _build_flywheel_extraction_prompt(body: FlywheelInspectRequest) -> str:
    ...
    return (
        ...
        "Special case: If the conversation explicitly requests improvements to the IKE flywheel "
        "system itself (e.g., flywheel inspection, candidate extraction, task-packet preview, "
        "controller packet handling), classify intent as flywheel_signal and produce at least "
        "one evolution_trigger_candidate (study, prototype, or review) describing the specific "
        "improvement. This is bounded: do not broaden to generic evolution requests.\n\n"
        "Extract:\n"
